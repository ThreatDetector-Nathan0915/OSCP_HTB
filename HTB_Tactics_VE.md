...
BOOM! We’ve got **RPC, NetBIOS, and SMB** — all vital components in Windows domain communication and file sharing. Time to probe!
...
## 🗝️ Foothold – Option A: Quiet Method Using `smbclient`
...
## ⚔️ Foothold – Option B: SYSTEM Shell Using Impacket's `psexec.py`
